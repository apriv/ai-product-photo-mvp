...
Compose the product as a clear hero subject but do not let it occupy the whole frame. Keep it roughly medium-sized, with balanced margins and usable visual areas around it where a separate text layer can sit without covering the product. Prefer natural negative space made from the scene composition, lighting, depth of field, or darker/lighter background regions rather than empty blank space.
